...
<html>
    ...
    <body>
        ...
        <p class="title"><b>The Dormouse's story</b></p> # b태그는 굵게 나오는 태그
...
# p 태그 접근
p1 = soup.html.body.p # 가장 첫번째 자식만 가져옴
print('p1', p1)

# 다음 태그
p2 = p1.next_sibling.next_sibling # next_sibling을 한번 호출하면 공백(p태그 끝나고 난 다음의 공백부분)을 호출함
print('p2', p2)
...
links2 = soup.find_all("a", class_='sister')  # id="link2" , string="Tillie" , string=["Elsie","Tillie"] , {} 다중 조건, limit = 2 옵션도 있음
print(links2)
...
# 태그 + 속성 선택자
link3 = soup.select_one("a[data-io='link3']") # class, id가 아닌 내가 임의로 정한 속성값은 대괄호로 묵고 들어가야 된다.
                                              # .은 class, #은 id
